...
async def generate_images(text_chunks, positive_prompt, negative_prompt):
    dir_path = "./out/images/"
    ...
    for text_chunk in text_chunks:
        image_coros.append(generate_image(session, text_chunk, positive_prompt, negative_prompt))
...
async def generate_image(session, text_chunk, positive_prompt, negative_prompt):
    body = {
        "width": 1344,
        "height": 768,
