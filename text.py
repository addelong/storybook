...
async def generate_story(prompt: str, style: str = "storybook") -> str:
    system = (
        ...
        "- Image paragraphs (PROMPTS): 1-3 sentences used verbatim as prompts to an AI image generator for the NEXT dialog paragraph. They must be purely visual descriptions, not narrative. Include all standalone context: character names, age, clothing, colors, setting, time of day, lighting, mood, camera framing, and any objects the next dialog references.\n"
        "- Dialog paragraphs (STORY): 1-2 short lines of narrative or character speech. Keep plot details and actions here.\n"
    ...
    user = (
        ...
        f"Image paragraphs are prompts (purely descriptive, no story beats). Dialog paragraphs carry the narrative.\n"
        f"Ensure each image paragraph concretely depicts the exact setting/object/character that the following dialog references, and includes all needed standalone context for consistent generation across images.\n"
