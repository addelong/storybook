...
class MainApp(QWidget):
    ...
    def initUI(self):
        ...
        self.image_text.setText("frightening, ominous, mysterious, spooky, unsettling, high quality photography, canon eos r3, photograph of ")
        self.image_negative_text.setText("blurry, bad, sloppy, incoherent, weird faces, messed up, weird hands, too many limbs or digits, anatomically incorrect, unnatural or creepy facial expression, generic or overused design, inconsistent scale or proportions, maniacal smiling, kid friendly, cartoon, silly")
